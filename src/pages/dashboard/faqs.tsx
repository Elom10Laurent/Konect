...
export default function FAQ() {
    ...
    return (
        // <div className="min-h-screen bg-background text-foreground from-gray-50 to-gray-100 py-12 px-6  space-y-8">
        ...
        //         <div className=" max-w-6xl mt-10 bg-gray-50 p-6 rounded-lg shadow-sm">
...
<div
  className="relative min-h-screen bg-background text-foreground py-12 px-6 space-y-8"
>
  {/* Contenu principal (au-dessus de l’image) */}
  <div className="relative max-w-6xl mx-auto bg-white/90 backdrop-blur-md rounded-2xl shadow-xl p-8">
    {/* Header */}
    <section className="text-center mb-10">
      <p className="font-semibold text-sm text-indigo-600 tracking-wide uppercase">
        <span className="rounded-full bg-indigo-200 px-2 py-0.5 text-xs mx-1">
          Konect
        </span>{" "}
        questions
      </p>
      ...
      <p className="text-gray-600 mt-3">
        Répondez au formulaire ci-dessous pour votre carte. <br /> Chaque section
        contient des informations essentielles pour compléter votre carte.
      </p>
    </section>
    ...
    <form className="w-full" onSubmit={handleSubmit}>
      ...
      <button
        type="submit"
        className="mt-4 flex w-full col-span-2 bg-gradient-to-r from-indigo-500 to-blue-600 text-white px-6 py-3 rounded-lg shadow-lg hover:opacity-90 transition text-center"
      >
        Enregistrer
      </button>
    </form>
    ...
    {/* Section d’explication */}
    <div className="max-w-6xl mt-10 bg-gray-50/90 backdrop-blur-md p-6 rounded-lg shadow-sm">
      <h2 className="text-2xl font-semibold text-gray-800 mb-4">
        Guide de remplissage du formulaire de création de carte
      </h2>
      <div className="mt-6 max-w-3xl mx-auto bg-pink-50 border border-pink-200 rounded-lg p-6">
        <h2 className="text-lg font-semibold text-pink-800">Besoin d’aide ?</h2>
        <p className="text-pink-700 mt-2">
          Chaque catégorie contient des champs spécifiques à remplir. Cliquez sur
          le titre pour ouvrir ou fermer la section.
        </p>
        <p className="text-pink-700 mt-2">
          Pour plus de détails, consultez notre{" "}
          <a href="#" className="underline font-medium">
